namespace WebApplication.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebApplication.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(WebApplication.Models.ApplicationDbContext context)
        {
            ...
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Bon Jovi", Description = "Rock concert of Bon Jovi Band", DateOfEvent = new DateTime(2021, 12, 25), AvailableTickets = 60000, PlaceName = "OAKA", PlaceAddress = "OAKA stadium EIRHNH", EventCategory = context.EventCategories.Find(1) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Def Leppard", Description = "Rock concert of Def Leppard Band", DateOfEvent = new DateTime(2021, 6, 15), AvailableTickets = 30000, PlaceName = "KARAISKAKH STADIUM", PlaceAddress = "FALIRO", EventCategory = context.EventCategories.Find(1) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Queensryche", Description = "Acoustic concert from Queensryche", DateOfEvent = new DateTime(2021, 9, 5), AvailableTickets = 5000, PlaceName = "SEF STADIUM", PlaceAddress = "FALIRO", EventCategory = context.EventCategories.Find(1) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "METALLICA", Description = "Rock concert from Metallica", DateOfEvent = new DateTime(2022, 1, 1), AvailableTickets = 45000, PlaceName = "MALAKASA", PlaceAddress = "MALAKASA", EventCategory = context.EventCategories.Find(1) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Iron maiden 2022", Description = "Rock concert from Iron Maiden band", DateOfEvent = new DateTime(2022, 6, 1), AvailableTickets = 65000, PlaceName = "OAKA", PlaceAddress = "OAKA stadium EIRHNH", EventCategory = context.EventCategories.Find(1) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Pyx Lax", Description = "Reunion concert from Pyx Lax band", DateOfEvent = new DateTime(2022, 12, 1), AvailableTickets = 2000, PlaceName = "Lazy Club", PlaceAddress = "Pentelis 1 avenue", EventCategory = context.EventCategories.Find(1) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Scorpions", Description = "One more last concert from Scorpions", DateOfEvent = new DateTime(2022, 12, 12), AvailableTickets = 10000, PlaceName = "Likavitos theater", PlaceAddress = "Likavitos", EventCategory = context.EventCategories.Find(1) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Web techs Webinar", Description = "Webinar about web application development", DateOfEvent = new DateTime(2022, 2, 10), AvailableTickets = 500, PlaceName = "Remote", PlaceAddress = "Remote", EventCategory = context.EventCategories.Find(5) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "C# Webinar", Description = "Webinar about C# application development", DateOfEvent = new DateTime(2022, 2, 20), AvailableTickets = 500, PlaceName = "Remote", PlaceAddress = "Remote", EventCategory = context.EventCategories.Find(5) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "ASP.NET Webinar", Description = "Webinar about ASP.NET technologies", DateOfEvent = new DateTime(2022, 3, 1), AvailableTickets = 800, PlaceName = "Remote", PlaceAddress = "Remote", EventCategory = context.EventCategories.Find(5) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "JAVA Webinar", Description = "Webinar about JAVA language", DateOfEvent = new DateTime(2022, 4, 1), AvailableTickets = 700, PlaceName = "Remote", PlaceAddress = "Remote", EventCategory = context.EventCategories.Find(5) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Spring Boot Webinar", Description = "Webinar about Spring Boot MVC technology", DateOfEvent = new DateTime(2022, 5, 5), AvailableTickets = 750, PlaceName = "Remote", PlaceAddress = "Remote", EventCategory = context.EventCategories.Find(5) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Spring Indoors Party", Description = "Spring afterhours party", DateOfEvent = new DateTime(2022, 4, 5), AvailableTickets = 350, PlaceName = "Crow live stage", PlaceAddress = "Sinopis 35", EventCategory = context.EventCategories.Find(4) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Summer beach Party", Description = "Summmer afterhours beach party in Varkiza", DateOfEvent = new DateTime(2022, 7, 5), AvailableTickets = 1200, PlaceName = "Yabanaki beach", PlaceAddress = "Yabanaki beach Varkiza", EventCategory = context.EventCategories.Find(4) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Summer beach Party allday", Description = "Summmer allday beach party in Vouliagmenh", DateOfEvent = new DateTime(2022, 7, 20), AvailableTickets = 2200, PlaceName = "Vouliagmenh beach", PlaceAddress = "Vouliagmenh beach", EventCategory = context.EventCategories.Find(4) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Summer beach Party Volos", Description = "Summmer beach party in Volos", DateOfEvent = new DateTime(2022, 8, 2), AvailableTickets = 1500, PlaceName = "Almiros beach", PlaceAddress = "Almiros beach Volos", EventCategory = context.EventCategories.Find(4) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "2021 ComicCon", Description = "ComicCon for year 2021", DateOfEvent = new DateTime(2021, 9, 10), AvailableTickets = 3000, PlaceName = "Some theater", PlaceAddress = "Some theater in Athens", EventCategory = context.EventCategories.Find(3) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "2022 ComicCon", Description = "ComicCon for year 2022", DateOfEvent = new DateTime(2022, 10, 10), AvailableTickets = 3000, PlaceName = "Some theater", PlaceAddress = "Some theater in Athens", EventCategory = context.EventCategories.Find(3) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "2023 ComicCon", Description = "ComicCon for year 2023", DateOfEvent = new DateTime(2023, 10, 10), AvailableTickets = 3000, PlaceName = "Some theater", PlaceAddress = "Some theater in Athens", EventCategory = context.EventCategories.Find(3) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "2021 GamesCon", Description = "GamesCon for year 2021", DateOfEvent = new DateTime(2021, 3, 10), AvailableTickets = 5000, PlaceName = "Some theater", PlaceAddress = "Some theater in Athens", EventCategory = context.EventCategories.Find(3) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "2022 GamesCon", Description = "GamesCon for year 2022", DateOfEvent = new DateTime(2022, 3, 10), AvailableTickets = 5000, PlaceName = "Some theater", PlaceAddress = "Some theater in Athens", EventCategory = context.EventCategories.Find(3) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "2023 GamesCon", Description = "GamesCon for year 2023", DateOfEvent = new DateTime(2023, 3, 10), AvailableTickets = 5000, PlaceName = "Some theater", PlaceAddress = "Some theater in Athens", EventCategory = context.EventCategories.Find(3) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Developers Day 2021", Description = "Karieras Developers day for year 2021", DateOfEvent = new DateTime(2021, 1, 10), AvailableTickets = 3000, PlaceName = "Technopolis", PlaceAddress = "Technopolis Gkazi", EventCategory = context.EventCategories.Find(2) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Developers Day 2022", Description = "Karieras Developers day for year 2022", DateOfEvent = new DateTime(2022, 1, 10), AvailableTickets = 3000, PlaceName = "Technopolis", PlaceAddress = "Technopolis Gkazi", EventCategory = context.EventCategories.Find(2) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Developers Day 2023", Description = "Karieras Developers day for year 2023", DateOfEvent = new DateTime(2023, 1, 10), AvailableTickets = 3000, PlaceName = "Technopolis", PlaceAddress = "Technopolis Gkazi", EventCategory = context.EventCategories.Find(2) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Developers Day 2024", Description = "Karieras Developers day for year 2024", DateOfEvent = new DateTime(2024, 1, 10), AvailableTickets = 3000, PlaceName = "Technopolis", PlaceAddress = "Technopolis Gkazi", EventCategory = context.EventCategories.Find(2) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Intrasoft Patras Bootcamp 2021", Description = "Bootcamp in Patras organized by Intrasoft", DateOfEvent = new DateTime(2021, 1, 5), AvailableTickets = 200, PlaceName = "Instrasoft Patras Building", PlaceAddress = "Old National Road", EventCategory = context.EventCategories.Find(5) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Intrasoft Patras Bootcamp 2022", Description = "Bootcamp in Patras organized by Intrasoft", DateOfEvent = new DateTime(2022, 1, 5), AvailableTickets = 200, PlaceName = "Instrasoft Patras Building", PlaceAddress = "Old National Road", EventCategory = context.EventCategories.Find(5) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Intrasoft Patras Bootcamp 2023", Description = "Bootcamp in Patras organized by Intrasoft", DateOfEvent = new DateTime(2023, 1, 5), AvailableTickets = 200, PlaceName = "Instrasoft Patras Building", PlaceAddress = "Old National Road", EventCategory = context.EventCategories.Find(5) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Intrasoft Patras Bootcamp 2024", Description = "Bootcamp in Patras organized by Intrasoft", DateOfEvent = new DateTime(2024, 1, 5), AvailableTickets = 200, PlaceName = "Instrasoft Patras Building", PlaceAddress = "Old National Road", EventCategory = context.EventCategories.Find(5) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Exotic art presentation", Description = "Exotic art presentation in Athens on 2022", DateOfEvent = new DateTime(2022, 5, 15), AvailableTickets = 150, PlaceName = "some nice Building", PlaceAddress = "Athens Downtown", EventCategory = context.EventCategories.Find(6) });
            context.Events.AddOrUpdate(e => e.Title, new Event { Title = "Athens Erotica 2022", Description = "Exotic erotic art presentation and performing in Athens on 2022", DateOfEvent = new DateTime(2022, 3, 2), AvailableTickets = 550, PlaceName = "some nice club", PlaceAddress = "Monastiraki", EventCategory = context.EventCategories.Find(6) });
